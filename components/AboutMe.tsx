        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className="md:w-2/3 text-center md:text-left">
            ...
            <p className="text-lg text-slate-700 dark:text-slate-300 mb-4 leading-relaxed">
              Welcome to my little corner of the internet! I'm passionate about sharing my
              journey through lifestyle vlogs, offering helpful study content, and creating
              authentic User-Generated Content (UGC) for brands I love.
            </p>

            <p className="text-lg text-slate-700 dark:text-slate-300 mb-4 leading-relaxed">
              My goal with <span className="font-semibold text-primary-dark dark:text-pink-400">
              Rupanta's Diary
              </span> is to inspire, connect, and bring a touch of positivity to your day.
              I believe in the power of storytelling and authentic connection, and I'm excited
              to share my experiences with you.
            </p>

            <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
              Whether you're here for study tips, a peek into my daily life, or to explore
              potential collaborations, I'm so glad to have you! Feel free to look around
